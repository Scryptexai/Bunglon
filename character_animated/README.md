...
This directory remains the Phase 5 animation asset handoff. **Phase 6** completed real Godot 4.3 import, `AnimationPlayer` / `AnimationTree` mapping, runtime helper resolution, safe semantic-event dispatch, imported projectile/VFX attachment points, and player/AI presentation integration; see [`../heroes/hero_agile_hunter/docs/PHASE_6_GODOT_INTEGRATION.md`](../heroes/hero_agile_hunter/docs/PHASE_6_GODOT_INTEGRATION.md). **Phase 9** now uses matching manifest timestamps to schedule independent gameplay ability timers without letting a visual signal become authority; see [`../heroes/hero_agile_hunter/docs/PHASE_9_ABILITY_TIMING.md`](../heroes/hero_agile_hunter/docs/PHASE_9_ABILITY_TIMING.md). **Later phases** still own broader combat gameplay validation, Android/mobile profiling, and final playtest sign-off.
