...
Roadmap terbaru menetapkan bahwa primitive/blocky mesh tidak boleh menjadi final character. Karena itu, visual native modular saat ini hanya **prototype teknis** dan tidak diklaim sebagai art final. **Phase 2 — 3D Character** kini menyediakan mesh `.glb` nyata di `character_final/`; Phase 3 harus menyelesaikan topology/UV/optimization sebelum gameplay phase tambahan dapat dinilai sebagai production-ready.
...
- [`character_final/`](character_final/) — GLB mesh, source generator, provisional PBR textures, render inspection, dan Phase 2 QA.
